...
async function sendChat() {
 ...
 async function getExerciseRecommendation() {
  ...
  .join("<br>");
    ...
    resultBox.innerHTML = formatted || "⚠️ No exercises found.";
  } catch (err) {
    console.error("Exercise error:", err);
    document.getElementById("exerciseResult").innerText = "⚠️ Failed to fetch exercises.";
  }
}
